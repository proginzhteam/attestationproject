...
```
cd existing_repo
git remote add origin https://gitlab.com/proginzhteam/attestationproject.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/proginzhteam/attestationproject/-/settings/integrations)
